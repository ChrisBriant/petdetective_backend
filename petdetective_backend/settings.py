"""
Django settings for petdetective_backend project.
...
SECRET_KEY = 'lb)uo$j36ur5304jxk1&7fieojomam4^0b@3f7$m7rzg$-65h3'
...
ROOT_URLCONF = 'petdetective_backend.urls'
...
WSGI_APPLICATION = 'petdetective_backend.wsgi.application'
